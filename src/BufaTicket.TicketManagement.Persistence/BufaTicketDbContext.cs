...
{
    public class BufaTicketDbContext : DbContext
    {
        public BufaTicketDbContext(DbContextOptions<BufaTicketDbContext> options)
            : base(options) { }

        private readonly ILoggedInUserService _loggedInUserService;
        public BufaTicketDbContext(DbContextOptions<BufaTicketDbContext> options, ILoggedInUserService loggedInUserService)
            : base(options) 
        {
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(BufaTicketDbContext).Assembly);
